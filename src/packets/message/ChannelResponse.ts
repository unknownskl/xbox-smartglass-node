...
export default class ChannelResponse extends Packet {
    ...
    target_channel_id = Buffer.from('0000000000000000', 'hex')
    result = 0
    ...
    constructor(packet:Buffer | ChannelResponseOptions, crypto:Crypto){
        ...
        if(packet instanceof Buffer){
            ...
            this.target_channel_id = protected_payload.read('bytes', 8)
    ...
    toPacket() {
        ...
        protected_payload_decoded.write('bytes', this.target_channel_id)
